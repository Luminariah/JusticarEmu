    /*
    Created by: QQRofl
	Edited by: Luminariah
	Integration: Trinity Core
	Date: 1/16/2013
    */
    ...
    {      
            ...
            if(player->GetTeam() == ALLIANCE)
                    snprintf(message, 250, "|cffEE9A00A[Borean Tundra Defense]: Alliance has %u resources!", m_ally_gathered);
            else
                    snprintf(message, 250, "|cffEE9A00A[Borean Tundra Defense]: Horde has %u resources!", m_horde_gathered);
    ...
    void OutdoorPvPBT::HandleReset()
    {
            ...
            limit_resources_message_A = 0;
            limit_resources_message_H = 0;
            sLog->outInfo(LOG_FILTER_GENERAL, "[OutdoorPvPBT]: Borean Tundra : HandleReset()");
    }
