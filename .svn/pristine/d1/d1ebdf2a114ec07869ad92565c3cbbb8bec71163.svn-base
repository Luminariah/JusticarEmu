...
#endif
#if SET_CURRENCY == 1
#define BOUNTY_1 "I would like to place a 350 honor bounty."
#define BOUNTY_2 "I would like to place a 750 honor bounty."
#define BOUNTY_3 "I would like to place a 1000 honor bounty."
#define BOUNTY_4 "I would like to place a 2000 honor bounty."
#endif
#if SET_CURRENCY == 2
...
void alertServer(const char * name, int msg)
{
        ...
        if(msg == 1)
        {
                message = "|cffEE9A00A bounty has been placed on ";
                message += name;
                message += "|cffEE9A00. Kill them immediately to collect the reward!";
        }
        else if(msg == 2)
        {
                message = "|cffEE9A00The bounty on ";
                message += name;
                message += "|cffEE9A00 has been collected!";
        }
                                ...
                                if(passChecks(pPlayer, code))
                                {
                                        ...
                                        switch (uiAction)
                                        {
                                                case GOSSIP_ACTION_INFO_DEF+5:
                                                {
                                                        ...
                                                        {
                                                                #if SET_CURRENCY != 1
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u','350', '1')", pBounty->GetGUID());
                                                                #else
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u','350', '1')", pBounty->GetGUID());
                                                                #endif
                                                                alertServer(code, 1);
                                                ...
                                                case GOSSIP_ACTION_INFO_DEF+6:
                                                {
                                                        ...
                                                        {
                                                                #if SET_CURRENCY != 1
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '750', '2')", pBounty->GetGUID());
                                                                #else
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '750', '2')", pBounty->GetGUID());
                                                                #endif
                                                                alertServer(code, 1);
                                                ...
                                                case GOSSIP_ACTION_INFO_DEF+7:
                                                {
                                                        ...
                                                        {
                                                                #if SET_CURRENCY != 1
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '1000', '3')", pBounty->GetGUID());
                                                                #else
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '1000', '3')", pBounty->GetGUID());
                                                                #endif
                                                                alertServer(code, 1);
                                                ...
                                                case GOSSIP_ACTION_INFO_DEF+8:
                                                {
                                                        ...
                                                        {
                                                                #if SET_CURRENCY != 1
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '2000', '4')", pBounty->GetGUID());
                                                                #else
                                                                CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '2000', '3')", pBounty->GetGUID());
                                                                #endif
                                                                alertServer(code, 1);
                                                                flagPlayer(code);
                                                                pPlayer->PlayerTalkClass->SendCloseGossip();
        ...
        public:
                ...
                void OnPVPKill(Player * Killer, Player * Bounty)
                {
                        ...
                        case 4:
                                ...
                                break;
                        case 5:
                                Killer->AddItem(TOKEN_ID, BOUNTY_PRICE_5);
                                break;
                        case 6:
                                Killer->AddItem(TOKEN_ID, BOUNTY_PRICE_6);
                                break;
                        case 7:
                                Killer->AddItem(TOKEN_ID, BOUNTY_PRICE_7);
                                break;
                        case 8:
                                Killer->AddItem(TOKEN_ID, BOUNTY_PRICE_8);
                                break;
                        }
#endif
