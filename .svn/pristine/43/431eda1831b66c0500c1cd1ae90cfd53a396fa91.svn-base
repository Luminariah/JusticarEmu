...
#define CUSTOM_LOCATION_GOSSIP          " -> Gurubashi Arena - PvP Zone" //Add your own custom location
#define CUSTOM_LOCATION_DUEL          " -> Dueling Area- PvP Zone" //Add your own custom location
#define CUSTOM_LOCATION_DUELFFA          " -> Free For All PvP Zone" //Add your own custom location
                                 ...
                                 if(Sender == GOSSIP_SENDER_MAIN)
                                 {
                                        switch(Actions)
                                        {
                                                ...
                                                case CUSTOM_AREAS_MENU:
														...
														player->ADD_GOSSIP_ITEM(FLIGHT_ICON, TEXT_CUSTOM_BLUE CUSTOM_LOCATION_DUEL, GOSSIP_SENDER_MAIN, DUEL_PORT);
														player->ADD_GOSSIP_ITEM(FLIGHT_ICON, TEXT_CUSTOM_BLUE CUSTOM_LOCATION_DUELFFA, GOSSIP_SENDER_MAIN, DUEL_PORTFFA);
                                                        player->ADD_GOSSIP_ITEM(CHAT_DOTS_ICON, TEXT_CUSTOM_RED NVM_GOSSIP, GOSSIP_SENDER_MAIN, NVM_EXIT);
                                                        player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
                                                break;
												...
												case DUEL_PORT:
                                                        player->TeleportTo(1, 5230.337402, -4797.181152, 691.315552, 5.953431);
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                break;

												case DUEL_PORTFFA:
                                                        player->TeleportTo(1, 6902.763184, -4791.687500, 695.211731, 5.134258);
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                break;
                                                ...
                                                case STORMWIND_PORT:
                                                        player->TeleportTo(571, 3956.114746f, -3770.123535f, 153.851624f, 6.065350f);
                                                        player->PlayerTalkClass->SendCloseGossip();
                                                break;
