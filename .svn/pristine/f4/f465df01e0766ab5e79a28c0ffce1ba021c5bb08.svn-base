...
class Player : public Unit, public GridObject<Player>
{
    ...
    private:
        ...
        uint32 m_ClearFakePlayerlist_timer;
        bool m_ForgetPlayersInBG;
        uint32 m_ForgetPlayersInBG_timer;
    public:
        explicit Player (WorldSession* session);
        ~Player();

        void SetPlayerInTeam(Battleground* bg, uint32 instanceId, BattlegroundTypeId bgTypeId, bool loggedIn = false);
